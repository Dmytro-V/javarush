        ...
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (stock1.containsKey("change"))
                    balance1 = (double)stock1.get("change");
                else
                    balance1 = (double)stock1.get("last") - (double)stock1.get("open");

                if (stock2.containsKey("change"))
                    balance2 = (double)stock2.get("change");
                else
                    balance2 = (double)stock2.get("last") - (double)stock2.get("open");
