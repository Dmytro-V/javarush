...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (classWithStatic.equals(loadedObject)) System.out.println(true);
    ...
    public static class ClassWithStatic {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = one;
            this.i = Integer.parseInt(two);
            this.j = Integer.parseInt(three);
        }
